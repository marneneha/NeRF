...
class StratifiedRaysampler(torch.nn.Module):
    ...
    def forward(
        ...
        step = (self.max_depth-self.min_depth)/self.n_pts_per_ray
        z_vals  = torch.arange(self.min_depth, self.max_depth, step, device = "cuda")
        # print("n_pts_per_ray is",self.n_pts_per_ray)
        # print("ray_bundle is",ray_bundle)
        # z_vals = 
